function gen_temp_mat(file_name)
  % --------------- Intro ---------------- % 
  ...
  xlswrite(strcat('../results/temp_', file_name, '.xls'), temp_matrix);
  xlswrite(strcat('../results/temp_', file_name, '_equilibrium.xls'), equilibrium_distribution_matrix);
end
